...
![Схема проекта](docs/imgs/schema.png)

---

## API документация

Полное описание всех эндпоинтов API можно найти в файле [api.md](docs/api/api.md). Основные разделы API:
...
![Схема базы данных](docs/imgs/db_schema.jpg)
...
OpenAPI спека: [тут](docs/api/schema.yaml)
...
Для Вашего удобного тестирования было создано 10 аккаунтов. Они расположены [здесь](docs/api/creds.md)
