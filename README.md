...
---
Проект разрабатывался в рамках соревнования по продуктовой разработке - PROD
Команда:
Arlandaren - аналитик/бекенд
Slezkins - бекенд/девопс
Sansly - бекенд
Quaddis - фронтенд
Anrean Augusta - фронтенд/дизайн
---
